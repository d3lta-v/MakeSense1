...
char aws_endpoint[]    = "ffffffff.iot.availability-zone.amazonaws.com";
char aws_key[]         = "IAM AWS KEY HERE";
char aws_secret[]      = "IAM AWS SECRET HERE";
char aws_region[]      = "AWS AVAILABLILITY ";
const char* aws_topic  = "availability-zone-here";
int port = 443;
...
response:
  ...
  // Send next message 30 seconds later
  delay(30000);
}
